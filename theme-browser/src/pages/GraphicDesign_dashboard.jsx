...
const GraphicDesign_dashboard = () => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/uploads/category/graphic-design`);
...
export default GraphicDesign_dashboard;